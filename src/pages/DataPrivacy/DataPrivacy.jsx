...
const DataPrivacy = () => {
  ...
  return (
    <main className="min-h-[100vh] p-4" id="privacy">
      <div ref={start}></div>
      ...
      {/* container */}
      <div className="mx-auto container max-w-4xl py-[150px]">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Mah-security.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Mah-security, accessible from{" "}
              <a
                href="http://www.mah-security.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                {" "}
                http://www.mah-security.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: mah-security@mycompany.com</li>
        </ul>
      </div>
